...
> # 👉 \*\*\*请某些人不要动不动就举报我, 不爱请别伤害, 我真谢谢您\*\*\*
>
> # 👉 在使用前请务必阅读以下内容
>
> # 👉 如果脚本失效或无法使用,请发个截图并更详细地说明问题,如果已解决,麻烦改个好评
>
> # 👉 请先安装脚本管理器(推荐 Tampermonkey)再安装此脚本，Tampermonkey 扩展可在当前浏览器扩展商店获取(见相关地址)
>
> # 👉 该脚本不支持页游防沉迷减料
...
✨ 支持 17yy, qq 空间, 07073, 4399, 7k7k 等游戏平台

😱 你是否因为防沉迷弹窗有东西而抓狂, 没关系, 这个脚本可以帮忙
...
> ## ❤️ 哪都能用
>
> > 已支持 17yy, qq 空间部分游戏, 07073, 7k7k, 4399
>
> ## ⚡️ 更加快速
>
> > 去除一堆花里胡哨的玩意, 减料速度提高到最快 1.99 秒
>
> ## 😱 别怕大人
>
...
> ## ⭕ 健康提醒
>
> > 每隔一段时间提醒用户休息, 防止用户沉迷游戏无法自拔
>
> ## 🌵 全屏游戏
>
> > 支持全屏游戏, 去除花里胡哨的玩意, 维护游戏体验
>
> ## 🕶 手动减料
>
...
> ❔ **脚本自动下载.swf 怎么关闭**
>
> > ❗ _点击菜单 `停用/启用全屏游戏和自动下载.swf文件` 即可_
>
> ❔ **一健报废怎么解除**
>
> > ❗ _删除脚本并重新安装, 或者修改存储_
...
> -   [4.5.4.5](#) 7 进一步加快减料速度, 新增手动减料( `shift + alt + 鼠标右键` )和一健报废, 以及细节优化 (7k7k 又能玩了)
